...
Feature: Status Code degeri 200 ise basarili degilse basarisiz degerlendirilecek test case senaryosu
  ...
  Scenario: GET metod ile istek atilarak status code degeri basarili olarak kabul edilir
  ...
  Scenario: GET metod ile istek atilarak status code degeri basarisiz kabul edilir
...
#    Then Status Code degerinin 500 oldugu dogrulanir
  ...
  Scenario: POST metod ile istek atilarak status code degeri basarili olarak kabul edilir
    * Status Code degerini 200 olarak ayarla ve "POST" metodu ile istek at
    Then Status Code degerinin 200 oldugu dogrulanir

  @StatusCode400 @POSTMethod
  Scenario: POST metod ile istek atilarak status code degeri basarisiz kabul edilir
